...
export default function CompanyForm({ company, onSave }: { company?: any; onSave?: () => void }) {
  ...
  const [form, setForm] = useState({
    ...
    old_registration_number: company?.old_registration_number ?? '',
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const payload = { ...form, tenant_id: userData?.tenant_id, public_interest_score: form.public_interest_score ? Number(form.public_interest_score) : null }
    const { error: dbError } = company?.id
